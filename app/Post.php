...
{
    protected $fillable = [
      'category_id', 'title', 'excerpt', 'body', 'iframe', 'published_at', 'user_id'
    ];
    ...
    {
      $query->with(['category', 'tags', 'owner', 'photos'])->whereNotNull('published_at')->where('published_at', '<=', Carbon::now())->latest('published_at');
    }
